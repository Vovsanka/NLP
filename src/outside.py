...
def compute_outside_for_nonterminals(
    ...
    # collect all nonterminals appearing in the grammar
    ...
    # initialize iside probabilities
    ...
    # propagate inside probabilities until convergence
    changed = True
    while changed:
        changed = False
        for sr in syntactic_rules:
    ...
    # propagate outside probabilities until convergence
    changed = True
    while changed:
        changed = False
        for sr in syntactic_rules:
    ...
    # output the outside weights for each nonterminal to stdout or a file
